...
public class PercolationVisualizer {
    ...
    // draw n-by-n PercolationTestFiles system
    ...
    public static void main(String[] args) {
        File f = new File(System.getProperty("user.dir") + File.separator + "src/PercolationThreshold/PercolationTestFiles/sedgewick60.txt");
        In in = new In(f);      // input file
        int n = in.readInt();         // n-by-n PercolationTestFiles system
