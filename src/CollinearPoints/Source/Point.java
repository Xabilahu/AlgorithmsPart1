...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        if (this.compareTo(that) == 0) return Double.NEGATIVE_INFINITY;
            ...
            if (Double.compare(slope, Double.NEGATIVE_INFINITY) == 0) return Double.POSITIVE_INFINITY;
            else if (Double.compare(slope, +0.0) == 0 || Double.compare(slope, -0.0) == 0) return +0.0;
            else return slope;
        }
    }
